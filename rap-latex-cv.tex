...
$if(jobtitle)$\moveleft.5\hoffset\centerline{\bf $jobtitle$}$endif$
$if(experience)$\moveleft.5\hoffset\centerline{$experience$}$endif$
$if(address)$\moveleft.5\hoffset\centerline{\bf $address$}$endif$
...
$if(linkedin)$$if(fontawesome)$\faLinkedin \hspace{1 mm}$else$\emph{Linkedin:}$endif$ \href{http://www.linkedin.com/in/$linkedin$}{\tt $linkedin$} \hspace{1 mm} $endif$
